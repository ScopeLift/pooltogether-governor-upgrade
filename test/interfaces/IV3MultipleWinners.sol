...
// Generated with `cast interface 0x178969A87a78597d303C47198c66F68E8be67Dc2`
interface IV3MultipleWinners {
  ...
  function beforeTokenMint(address to, uint256 amount, address controlledToken, address referrer)
    external;
  function beforeTokenTransfer(address from, address to, uint256 amount, address controlledToken)
    external;
  ...
  function getExternalErc721AwardTokenIds(address _externalErc721)
    external
    view
